...
public class BasicExample<T> implements BasicExampleLocal<T> {
	...
	public Result<T> searchRestaurant(String location)
		...
		FoursquareApi foursquareApi = new FoursquareApi(
				"DWHLE1OQJBM2HENXFNAR1CGPOEYTCEKHRSF5AV5ZXGD5ZT1Q",
				"P5AKFTGQUJQSYOZMI02KO4H55ZBP1JGQ3CELF44YR2S3XF4D",
				"http:\\\\localhost\\");
		...
		Result<VenuesSearchResult> result = foursquareApi.venuesSearch(
				location, null, null, null, null, 100, null,
				"4bf58dd8d48988d1e0931735", null, null, null, null, null);

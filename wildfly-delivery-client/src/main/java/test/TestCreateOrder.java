...
public class TestCreateOrder {
	...
	public static void main(String[] args) {
		...
		order.setCustomer(new ServicesBasicDelegate<Customer>().doCrud().findById(SimpleUser, Customer.class));
		order.setRestaurant(new ServicesBasicDelegate<entities.Restaurant>().doCrud().findById(Restaurant, entities.Restaurant.class));
		...
		System.out.println(orderServiceDelegate.findOrderByCustomer(SimpleUser));
		
		System.out.println("Find By Restaurant : \n \t ");
		System.out.println(orderServiceDelegate.findOrderByRestaurant(Restaurant));
	}
}
